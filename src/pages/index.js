    ...
    <Layout
      ...
      <main>
        <section className={styles.features}>
              <div className="container">
                <div className="row">
                  <b><Translate id="homepage.disclaimer">Disclaimer:</Translate>&nbsp;</b><Translate id="homepage.warning">The content of this Website is not medical advices or exercices you must follow, you have the full responsibility of your experimentations. Moreover, the content of this Website can change at anytime, please check the number version of documentation. Version 0.1.0</Translate>
                </div>
              </div>
        </section>
