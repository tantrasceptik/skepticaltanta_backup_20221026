...
module.exports = {
  ...
  baseUrl: '/skepticaltantra_backup_20221026/',
  onBrokenLinks: 'throw',
  onBrokenMarkdownLinks: 'warn',
  favicon: 'img/logo.svg',
  organizationName: 'Skeptical-Tantra', // Usually your GitHub org/user name.
  projectName: 'skepticaltantra_backup_20221026', // Usually your repo name.
  trailingSlash: false,
    ...
    [
      '@docusaurus/preset-classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/tantrasceptik/skepticaltantra_backup_20221026/tree/main',
        ...
        blog: {
          ...
          // Please change this to your repo.
          editUrl:
            'https://github.com/tantrasceptik/skepticaltantra_backup_20221026/tree/main/blog',
          editLocalizedFiles: true,
        },
        theme: {
